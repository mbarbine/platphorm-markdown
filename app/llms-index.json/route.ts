  ...
  return NextResponse.json(
    {
      ...
      integrations: {
        trace: "response-header propagation active; external export degraded",
        docs: "report generation degraded",
        sheets: "report generation degraded",
        decks: "summary generation degraded",
        ...
        claws: "remediation integration degraded",
      },
